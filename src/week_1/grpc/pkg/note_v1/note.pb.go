...
type UpdateNoteInfo struct {
	...
	Context  *wrappers.StringValue `protobuf:"bytes,2,opt,name=context,proto3" json:"context,omitempty"`
...
func (x *UpdateNoteInfo) GetContext() *wrappers.StringValue {
	if x != nil {
		return x.Context
	}
	return nil
...
type CreateRequest struct {
	...
	Infp *NoteInfo `protobuf:"bytes,1,opt,name=infp,proto3" json:"infp,omitempty"`
}
...
func (x *CreateRequest) GetInfp() *NoteInfo {
	if x != nil {
		return x.Infp
	}
	return nil
...
type ListRequest struct {
	...
	Linit  int32 `protobuf:"varint,1,opt,name=linit,proto3" json:"linit,omitempty"`
...
func (x *ListRequest) GetLinit() int32 {
	if x != nil {
		return x.Linit
	}
	return 0
...
var file_note_proto_rawDesc = []byte{
	...
	0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x6e, 0x6f, 0x74, 0x65, 0x5f, 0x76,
	0x31, 0x2e, 0x4e, 0x6f, 0x74, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x70,
	...
	0x74, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x69, 0x6e, 0x69, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x05, 0x6c, 0x69, 0x6e, 0x69, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65,
	...
	0x6f, 0x6d, 0x2f, 0x78, 0x64, 0x65, 0x76, 0x73, 0x70, 0x6f, 0x2f, 0x67, 0x6f, 0x2d, 0x6d, 0x69,
	0x63, 0x72, 0x6f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_note_proto_depIdxs = []int32{
	...
	0,  // 7: note_v1.CreateRequest.infp:type_name -> note_v1.NoteInfo
